...
var dict = {
    ...
    "Reasonfordeleting": {
        jp: "備考/ VINを削除する理由を入力してください",
        en: "Please enter remarks / reason for deleting the VIN"
    },
    "Responsible": {
        jp: "担当者",
        en: "Responsible"
    ...
    "No file available for this VIN and Model":
    {
        jp: "このVINとモデルに使用できるファイルはありません！..",
        en: "No file available for this VIN and Model!.."
    },
    "Rework":
    {
        jp: "未修整",
     ...
     "VinHistoryAsZip":
    {
     ...
     "Invalid VIN. Please check VIN again":
     {
         jp: "無効なVIN。もう一度VINを確認してください",
         en:"Invalid VIN. Please check VIN again"
    },
    "Specified Model is not available in masters. Please check":
    {
        jp: "指定されたモデルはマスターでは使用できません。チェックしてください",
        en: "Specified Model is not available in masters. Please check"
    },
    "Please select Plant to proceed":
    {
        jp: "続行するにはプラントを選択してください",
        en: "Please select Plant to proceed"
    },
    "Are you sure? Want to submit the VIN :": {
        jp: "本気ですか？ VINを送信したい：",
        en: "Are you sure? Want to submit the VIN :"
    },
    "Checklist not available for selected Q-Gate":
    {
        jp: "選択したQ- Gateのチェックリストは利用できません",
        en: "Checklist not available for selected Q-Gate"
    },
    "Actuals/Comments added":
    {
            jp: "追加された実績/ コメント",
        en: "Actuals/Comments added"
    },
    "Actuals/Comments updated":
    {
        jp: "実績/ コメントを更新しました",
        en: "Actuals/Comments updated"
    },
    "Actuals/Comments deleted":
    {
        jp: "実績/コメントを削除しました",
        en: "Actuals/Comments deleted"
    },
    "Are you sure? Want to delete this Actuals/comments?":
    {
        jp: "本気ですか？この実績/コメントを削除しますか？",
        en: "Are you sure? Want to delete this Actuals/comments?"
    },
    "No Defect Place available for selected Item. Please add Defect place in masters / Contact Admin":
    {
        jp: "選択したアイテムに使用できる欠陥場所はありません。マスターに欠陥箇所を追加してください/管理者に連絡してください",
        en: "No Defect Place available for selected Item. Please add Defect place in masters / Contact Admin"
    },
    "Are you sure? Please confirm your inputs":
    {
        jp: "本気ですか？入力を確認してください",
        en: "Are you sure? Please confirm your inputs"
    },
    "New defect added to the check item":
    {
        jp: "チェック項目に追加された新しい欠陥",
        en: "New defect added to the check item"
    },
    "Are you sure? Want to complete this VIN inspection in this Q-Gate?":
    {
        jp: "本気ですか？このQ-GateでこのVIN検査を完了してみませんか？",
        en: "Are you sure? Want to complete this VIN inspection in this Q-Gate?"
    },
    "Are you sure? Want to cancel the completion of Inspection in the Q-Gate?":
    {
        jp: "本気ですか？ Q-Gateでの検査完了をキャンセルしたいですか？",
        en: "Are you sure? Want to cancel the completion of Inspection in the Q-Gate?"
    },

    "Deleting this VIN will delete all information about this VIN and can not be reverted back. Are you sure? Want to delete the VIN?":
    {
        jp: "このVINを削除すると、このVINに関するすべての情報が削除され、元に戻すことはできません。本気ですか？ VINを削除しますか？",
        en: "Deleting this VIN will delete all information about this VIN and can not be reverted back. Are you sure? Want to delete the VIN?"
    },
    "Please enter remarks / reason for deleting the VIN":
    {
        jp: "備考/ VINを削除する理由を入力してください",
        en: "Please enter remarks / reason for deleting the VIN"
    },
    "VIN has been successfully deleted!":
    {
        jp: "VINは正常に削除されました！",
        en: "VIN has been successfully deleted!"
    },


    "Q-Gate created successfully":
    {
        jp: "Q-Gateが正常に作成されました",
        en: "Q-Gate created successfully"
    },
    "Q-Gate updated successfully":
    {
        jp: "Q- Gateが正常に更新されました",
        en: "Q-Gate updated successfully"
    },
 
    "Q-Gate exists already with same name. Please use different name.":
    {
        jp: "Q- Gateはすでに同じ名前で存在しています。別の名前を使用してください",
        en: "Q-Gate exists already with same name. Please use different name"
    },
    
    "New Standard Reference inserted successfully":
    {
        jp: "新しい標準参照が正常に挿入されました",
        en: "New Standard Reference inserted successfully"
    },
    "Are you sure? Want to delete this? If you delete this all related and information will be lost.":
    {
        jp: "本気ですか？これを削除しますか？これを削除すると、関連するすべての情報が失われます",
        en: "Are you sure? Want to delete this? If you delete this all related and information will be lost."
    },
    "Standard Reference deleted successfully":
      {
        jp: "標準参照が正常に削除されました",
        en: "Standard Reference deleted successfully"
    },
    "File format not supported. Please upload docuemnts in PDF Format":
    {
        jp: "サポートされていないファイル形式です。ドキュメントをPDF形式でアップロードしてください",
        en: "File format not supported. Please upload docuemnts in PDF Format"
    },
    "Standard Reference exists already with same name. Please use different name.":
    {
        jp: "同じ名前の標準参照がすでに存在しています。別の名前を使用してください",
        en: "Standard Reference exists already with same name. Please use different name"
    },
    ...
    "New Defect place template created successfully":
    {
        jp: "新しい欠陥場所テンプレートが正常に作成されました",
        en: "New Defect place template created successfully"
    },
    "Defect place template updated successfully":
    {
        jp: "欠陥場所テンプレートが正常に更新されました",
        en: "Defect place template updated successfully"
    },
    "Are you sure? Want to delete this? If you delete this all related and information will be lost":
    {
        jp: "本気ですか？これを削除しますか？これを削除すると、関連するすべての情報が失われます",
    ...
    "Defect place template deleted successfully":
    {
        jp: "欠陥場所テンプレートが正常に削除されました",
        en: "Defect place template deleted successfully"
    },
    "Defect place template exists already with same name. Please use different name.":
    {
        jp: "同じ名前の欠陥場所テンプレートがすでに存在しています。別の名前を使用してください。",
        en: "Defect place template exists already with same name. Please use different name."
    },
    "Please select Plant to proceed":
    {
        jp: "続行するにはプラントを選択してください",
    ...
    "New Vehcile type created successfully":
    {
        jp: "新しいVehcileタイプが正常に作成されました",
        en: "New Vehcile type created successfully"
    },
    "Vehcile type updated successfully":
    {
        jp: "Vehcileタイプが正常に更新されました",
        en: "Vehcile type updated successfully"
    },
    "Are you sure? Want to delete this? If you delete this all related and information will be lost":
    {
        jp: "本気ですか？これを削除しますか？これを削除すると、関連するすべての情報が失われます",
    ...
    "Vehcile type deleted successfully":
    {
        jp: "Vehcileタイプが正常に削除されました",
        en: "Vehcile type deleted successfully"
    },
    "Vehicle type exists already with same name. Please use different name":
      {
        jp: "車両タイプは同じ名前ですでに存在しています。別の名前を使用してください",
        en: "Vehicle type exists already with same name. Please use different name"
    },

    "New Model created successfully":
      {
        jp: "新しいモデルが正常に作成されました",
        en: "New Model created successfully"
    },
    ...
    "Model exists already with same name. Please use different name":
    {
        jp: "同じ名前のモデルがすでに存在します。別の名前を使用してください",
        en: "Model exists already with same name. Please use different name"
    },

    "Error Upload checklist. Please check the template and mke sure all columns are in same order. If issue persists, contact Admin.":
      {
        jp: "エラーチェックリストのアップロード。テンプレートを確認し、すべての列が同じ順序であることを確認してください。問題が解決しない場合は、管理者に連絡してください",
        en: "Error Upload checklist. Please check the template and mke sure all columns are in same order. If issue persists, contact Admin."
    },
    "Checklist uploaded successfully":
    {
        jp: "チェックリストが正常にアップロードされました",
        en: "Checklist uploaded successfully"
    },
    "Are you sure want to delete this Checklist ? If you delete, all the related Checklist and information will be lost":
    {
        jp: "このチェックリストを削除してもよろしいですか？削除すると、関連するすべてのチェックリストと情報が失われます",
        en: "Are you sure want to delete this Checklist ? If you delete, all the related Checklist and information will be lost"
    },
    ...
    "Close":
{
    ...
    "Enter atleast one manager Id":
    {
        jp: "少なくとも1人のマネージャーIDを入力してください",
        en: "Enter atleast one manager Id"
    },

    "Enter atleast one User Id":
    {
        jp: "少なくとも1つのユーザーIDを入力してください",
        en: "Enter atleast one User Id"
    },
    ...
    {
        jp: "すべての進捗モニター",
        en: "All Progress Monitor"
    },

    "Progress Monitor All":
    {
        jp: "進捗監視すべて",
        en: "Progress Monitor All"
    },
    "Mitsubishi Fuso Bus Manufacturing Co., Ltd.":
     {
        jp: "Mitsubishi Fuso Bus Manufacturing Co., Ltd.",
        en: "Mitsubishi Fuso Bus Manufacturing Co., Ltd."
    },
}
...
$(document).ready(function () {
  ...
  //  $('.Languagepicker').selectpicker();
    ...
    $('.Languagepicker').on('change', function (ev) {
        ...
        //alert(selected);
        var ApiFunc = '../Home/LanguageChanger?lan=' + selected;
...
function AutomatedQFLPage() {
    ...
    $(".AutomatedQFLPage-emailnotification").mCustomScrollbar({
    ...
    $(".AutomatedQFLPage-emailnotification").height($height);
    ...
    $(".AutomatedQFLPage-progressmonitor-page").mCustomScrollbar({
    ...
    $(".AutomatedQFLPage-progressmonitor-page").height($height);
    ...
    //$(".AutomatedQFLPage-progressmonitorAll-page").mCustomScrollbar({
    ...
    $(".AutomatedQFLPage-progressmonitorAll-page").height($height);


$(".AutomatedQFLPage-PaintMaster-page").mCustomScrollbar({
...
$height = $(window).height() - 550;
    ...
    $(".AutomatedQFLPage-PaintMaster-page").height($height);

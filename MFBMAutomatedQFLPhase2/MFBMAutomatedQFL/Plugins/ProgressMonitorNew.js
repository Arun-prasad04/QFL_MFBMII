...
$(document).ready(function () {
    ...
    $("#liProgressMonitorNew").addClass("active");
    InitializeUrl();
...
function ProgressMonitor(plantid) {
    ...
    var ApiFunc = Api + 'Monitor.svc/GetProgressMonitorNewData';
    PostMethod(ApiFunc, Input, Token, function (data) {
        showloader();
        FilterI = "";
...
function BindData(data) {
    ...
    $.each(data.listlinedetails, function (i, item) {
        ...
        //tablebody += '<tbody><tr>';
        lineheader += '<div id="tab' + i + '" onclick=ClickLineCollapse("LineId",' + item.lineid+','+i+')  class="panel panel-default"><div class="panel-heading">';
        lineheader += '<a data-toggle="collapse" class="collapsed" data-parent="#accordions" href="#collapse' + i + '">';
        lineheader += '<h4 class="panel-title">' + item.linename + '<span class="circle pull-right"><i class="fa"></i></span></h4></a></div>';
        tableheader += '<div id="collapse' + i + '" class="' + collapse + '"><div class="table-responsive IE-display-block">';
        tableheader += '<table id="tblbinding" class="table table-bordered sorttable" style ="display:none;width:' + DynamicColumn[0].Counts + 'px">';
        //tableheader += '<table class="table table-bordered"  style = "width: 1337px;">';
        tableheader += '<thead><tr class="tblheadtext"><th style="width: 150px"><span class="trn">VIN</span></th><th style="width: 150px"><span class="trn">Vehicle Type</span></th><th style="width: 150px" id="model"><span class="trn">Model</span></th>';
        tableFilter += '<div class="tableFixHead IE-mt-0 AutomatedQFLPage-progressmonitor' + i + '" style="width:' + DynamicColumn[0].Counts + 'px"><table id="sorttable' + i + '" class="table table-bordered text-center sorttables" style ="width:' + DynamicColumn[0].Counts + 'px">';
        tableheaderhide += '<tr class="tblheadtext"><th style="width: 150px"><span class="trn">VIN</span></th><th style="width: 150px"><span class="trn">Vehicle Type</span></th><th style="width: 150px" id="model"><span class="trn">Model</span></th>';
        tableheaderhide += '<th style="width: 250px" ><span class="trn">Part Name</span></th><th style="width: 250px"><span class="trn">Defect</span></th><th style="width: 150px"><span class="trn">Status</span></th> <th style="width: 150px"><span class="trn">Comments</span></th> <th style="width: 150px"><span class="trn">Photo</span></th>';
        ...
        tableheader += '<th style="width: 250px" ><span class="trn">Part Name</span></th><th style="width: 250px"><span class="trn">Defect</span></th><th style="width: 150px"><span class="trn">Status</span></th> <th style="width: 150px"><span class="trn">Comments</span></th> <th style="width: 150px"><span class="trn">Photo</span></th>';
        ...
        $.each(secondItem, function (i, item) {
            ...
            $.each(thirdItem, function (i, item) {
                    ...
                    tablebody += '<tr class="Rowsspanclass">';
                  



                tablebody += ' <td style="width: 150px;background-color:' + item.VinnumberColor + '" id="Vinnumber_' + item.VinNumber + '"  class="Vinnumber Vinnumber_' + item.VinNumber + '">' + item.VinNumber + ' <div style="display:none;" class="Vinnumberclr ColorApply" id="colorid_Vinnumber_' + item.QFLFeedbackWorkflowId + '"> <div class="square" onclick=GetColour("red")></div>  <div class="square1" onclick=GetColour("Yellow")></div> <div class="square2" onclick=GetColour("deepskyblue")></div> <div class="square3" onclick=GetColour("White")></div>  </div>  </td> '; // No header only hidden field for variant and modalid

                tablebody += '<td style="width: 150px;background-color:' + item.ModalColor + '" id="Vehicle_' + item.VinNumber + '"  class="Vehicle Vehicle_' + item.VinNumber + '">' + item.VehicleType + ' <div style="display:none;" class="Vehicleclr ColorApply" id="colorid_Vehicle_' + item.QFLFeedbackWorkflowId + '"> <div class="square" onclick=GetColour("red")></div> <div class="square1" onclick=GetColour("Yellow")></div> <div class="square2" onclick=GetColour("deepskyblue")></div> <div class="square3" onclick=GetColour("White")></div>  </div></td> '; // No header only hidden field for variant and modalid

                tablebody += '<td style="width: 150px;background-color:' + item.VehicleColor + '" id="Modal_' + item.VinNumber + '" class="Modal Modal_' + item.VinNumber + '">' + item.ModelName + ' <div style="display:none;" class="Modalclr ColorApply" id="colorid_Modal_' + item.QFLFeedbackWorkflowId + '"> <div class="square" onclick=GetColour("red")></div> <div class="square1" onclick=GetColour("Yellow")></div> <div class="square2" onclick=GetColour("deepskyblue")></div> <div class="square3" onclick=GetColour("White")></div>  </div></td> '; // No header only hidden field for variant and modalid


                tablebody += '<td   style="width: 250px;background-color:' + item.DefectColor + '" id="PartName_' + item.QFLFeedbackWorkflowId + '"  class="PartName">' + item.inspectionitem + ' <div style="display:none;" class="PartNameclr ColorApply" id="colorid_PartName_' + item.QFLFeedbackWorkflowId + '"> <div class="square" onclick=GetColour("red")></div>  <div class="square1" onclick=GetColour("Yellow")></div> <div class="square2" onclick=GetColour("deepskyblue")></div> <div class="square3" onclick=GetColour("White")></div>  </div></td> ';
                // '<div style="display:block" id="colorid_' + item.QFLFeedbackWorkflowId + '"> <div class="square" onclick=GetColour("red")></div> <div class="square1" onclick=GetColour("Yellow")></div> <div class="square2" onclick=GetColour("deepskyblue")></div>  </div> '


                if (item.Site1Image == "") {
                    tablebody += '<td style="width: 250px;background-color:' + item.DefectColor + '" id="Defect_' + item.QFLFeedbackWorkflowId + '" class="Defect">' + item.Defect + ' <div style="display:none;" class="Defectclr ColorApply" id="colorid_Defect_' + item.QFLFeedbackWorkflowId + '"> <div class="square" onclick=GetColour("red")></div> <div class="square1" onclick=GetColour("Yellow")></div> <div class="square2" onclick=GetColour("deepskyblue")></div> <div class="square3" onclick=GetColour("White")></div>  </div></td>';
                }
                else {
                ...
                tablebody += '<td style="width: 150px">'
                ...
                if (ReworkCyclecount == 0) {
                    ...
                    if (item.CheckListItemStatusId == 3 || item.CheckListItemStatusId == 6) {
                      //  tablebody += (' <span class="">Not Ok</span> ');
                ...
                tablebody += '<td style="width: 150px" class="checkdisabled"> <a href="#"  class="btn btn-comment ' + UploadedImageDisabled + '" onclick="btnOpenUploadedImage(\'' + item.NotOkUploadImage + '\'  ,\'' + item.VinNumber + '\',\'' + item.ModelName + '\' )" id=""  data-toggle="tooltip" title="Photo"   aria-hidden="true" id="" style=""><i id="" class="fa fa-picture-o"></i></a>';
                tablebody += '<span style="display:none">' + Checkdataavaibility+'</span> </td >';
                ...
                tablebody += '<td style="width: 150px;display: none;"  class="QFLFeedbackWorkflowIdtxt">' + item.QFLFeedbackWorkflowId + '</td> ';
                tablebody += '<td style="width: 150px;display: none;"  class="VinIdtxt">' + item.VinId + '</td> ';
        ...
        tableheaderhide += '<th class="" style="width: 150px;display: none;"><span class="trn ">QFLworkFlowId</span></th><th class="" style="width: 150px;display: none;"><span class="trn ">VinId</span></th>';
...
var glbLineid=0
function ClickLineCollapse(value, LineId,i) {
    FilterI=i
    glbLineid = LineId;
...
//                if (last !== group) {
//                    $(rows).eq(i).before(
//                        '<tr class="group"><td colspan="7">' + group + '</td> <tr class="group"><td colspan="8">' + group + '</td> </tr>'
//                    );
...
//        lineheader += '<h4 class="panel-title">' + item.linename + '<span class="circle pull-right"><i class="fa"></i></span></h4></a></div>';
//        tableheader += '<div id="collapse' + i + '" class="' + collapse + '"><div class="table-responsive IE-display-block">';
//        tableheader += '<table id="tblbinding" class="table table-bordered sorttable" style ="width:' + DynamicColumn[0].Counts + 'px">';
//        //tableheader += '<table class="table table-bordered"  style = "width: 1337px;">';
//        tableheader += '<thead><tr class="tblheadtext"><th style="width: 150px"><span class="trn">VIN</span></th><th style="width: 150px"><span class="trn">Vehicle Type</span></th><th style="width: 150px" id="model"><span class="trn">Model</span></th>';
//        tableheaderhide += '<div class="IE-mt-0 AutomatedQFLPage-progressmonitor' + i + '"><table id="sorttable' + i + '" class="table table-bordered text-center sorttable" style ="width:' + DynamicColumn[0].Counts + 'px"><thead style="display:none"><tr class="tblheadtext"><th style="width: 150px"><span class="trn">VIN</span></th><th style="width: 150px"><span class="trn">Vehicle Type</span></th><th style="width: 150px" id="model"><span class="trn">Model</span></th>';
//        tableheaderhide += '<th style="width: 250px" ><span class="trn">Part Name</span></th><th style="width: 250px"><span class="trn">Defect</span></th><th style="width: 150px"><span class="trn">Status</span></th> <th style="width: 150px"><span class="trn">Comments</span></th> <th style="width: 150px"><span class="trn">Photo</span></th></tr></thead>';
...
//                    tablebody += ' <td style="width: 150px" rowspan=' + count + ' class="Vinnumbertxt">' + item.VinNumber + '</td> '; // No header only hidden field for variant and modalid

//                    tablebody += '<td style="width: 150px" rowspan=' + count + '>' + item.VehicleType + '</td> '; // No header only hidden field for variant and modalid

//                    tablebody += '<td style="width: 150px" rowspan=' + count + '>' + item.ModelName + '</td> '; // No header only hidden field for variant and modalid


//                    tablebody += '<td style="width: 250px"  class="partNametxt">' + item.inspectionitem + '</td> ';
...
//                    if (item.Site1Image == "") {
//                        tablebody += '<td style="width: 250px" id="Defecttxt" class="Defecttxt">' + item.Defect + '</td>';
//                    }
//                    else {

//                        if (item.Defect == "") {
//                            //  tablebody += '<td style="width: 150px">' + '<img style="width:inherit" id="" src="../SignatureSitePath/' + item.VinNumber + '/' + item.Site1Image + '" />' + '</td> '; // No header only hidden field for variant and modalid
//                            tablebody += '<td style="width: 250px">' + '<img style="width:50px" id="" src="' + UserDetails.SignatureSitePath + '/' + item.VinNumber + '/' + item.Site1Image + '" />' + '</td> '; // No header only hidden field for variant and modalid

//                        }
//                        else {
//                            // tablebody += '<td style="width: 150px">' + item.Defect + " , " + '<img style="width:inherit" id="" src="../SignatureSitePath/' + item.VinNumber + '/' + item.Site1Image + '" />' + '</td> '; // No header only hidden field for variant and modalid
//                            tablebody += '<td style="width: 250px"  class="Defecttxt">' + item.Defect + " , " + '<img style="width:50px" id="" src="' + UserDetails.SignatureSitePath + '/' + item.VinNumber + '/' + item.Site1Image + '" />' + '</td> '; // No header only hidden field for variant and modalid
...
//                    tablebody += '<td style="width: 150px" class="checkdisabled"> <a href="#"  class="btn btn-comment ' + UploadedImageDisabled + '" onclick="btnOpenUploadedImage(\'' + item.NotOkUploadImage + '\'  ,\'' + item.VinNumber + '\' )" id=""  data-toggle="tooltip" title="Photo"   aria-hidden="true" id="" style=""><i id="" class="fa fa-picture-o"></i></a>';
//                    tablebody += '</td >';
...
//                                if (DynamicDetails1.length > 0) {
//                                    for (var n = 0; n < DynamicDetails1.length; n++) {
//                                        tablebody += '<td style="width: 150px" id="DynamicdetailsId_' + item.QFLFeedbackWorkflowId + '_' + DynamicDetails1[n].NewProgressColumnId + '">' + DynamicDetails1[n].DynamicColumnDetails + '</td>';
//                                    }
//                                }
//                                else {


//                                    tablebody += '<td style="width: 150px" id="DynamicdetailsId_' + item.QFLFeedbackWorkflowId + '_' + DynamicColumn[j].NewProgressColumnId + '"></td>';
...
//                            for (var n = 0; n < DynamicColumn.length; n++) {
//                                if (DynamicColumn[n].DynamicColumnName != "") {
//                                    tablebody += '<td style="width: 150px" id="DynamicdetailsId_' + item.QFLFeedbackWorkflowId + '_' + DynamicColumn[n].NewProgressColumnId + '"></td>';
//                                }
...
//                    tablebody += ' <td   style="display: none;" class="Rowspanvin">' + item.VinNumber + '</td> ';
//                    tablebody += '<td   style="display: none;"  class="RowspanVehicle">' + item.VehicleType + '</td> ';
//                    tablebody += '<td   style="display: none;"  class="RowspanModel">' + item.ModelName + '</td> ';

//                    tablebody += '<td style="width: 250px"  class="partNametxt">' + item.inspectionitem + '</td> ';

//                    tablebody += ' <td style="display: none;" class="Vinnumbertxt">' + item.VinNumber + '</td> ';
//                    tablebody += '<td style="display: none;"  class="QFLFeedbackWorkflowIdtxt">' + item.QFLFeedbackWorkflowId + '</td> ';
//                    tablebody += '<td style="display: none;"  class="VinIdtxt">' + item.VinId + '</td> ';

//                    if (item.Site1Image == "") {
//                        tablebody += '<td style="width: 250px"  class="Defecttxt">' + item.Defect + '</td>';
//                    }
//                    else {
...
//                    tablebody += '</td >'; // No header only hidden field for variant and modalid

//                    //tablebody += '<td style="width: 150px"  DefectValue="' + item.Defect + '"  class="" onclick=btnReExamCommunicate(this,"' + item.VinId + '",' + item.QFLFeedbackWorkflowId + ',"' + item.inspectionitem + '","' + item.VinNumber + '") >';

//                    //tablebody += ('<span class="feebback-pending-buttons">');
//                    //tablebody += ('<img  id="" src="../Images/Comment-chat.png" />');
//                    //tablebody += ('</span>');
//                    //tablebody += '</td >';
...
//        tableheader += '</tr></thead></table>'
//        //tableFilter += '<tr class="tblheadtext filter' +i+'"><th style="width: 150px"><span class="trn">VIN</span></th><th style="width: 150px"><span class="trn">Vehicle Type</span></th><th style="width: 150px" id="model"><span class="trn">Model</span></th>'
//        //tableFilter += '<th style="width: 250px" ><span class="trn">Part Name</span></th><th style="width: 250px"><span class="trn">Defect</span></th></tr></thead></table>'
...
//        lineheader = ''; tableheader = ''; tablebody = ''; tablefooter = ''; tableheaderhide = ''; tableFilter = ''
//    });
